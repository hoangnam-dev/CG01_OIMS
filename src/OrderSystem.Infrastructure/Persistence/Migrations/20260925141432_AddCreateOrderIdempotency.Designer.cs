...
namespace OrderSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925141432_AddCreateOrderIdempotency")]
    partial class AddCreateOrderIdempotency
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("idempotency_requests", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_idempotency_requests_response_body_size", "response_body_json IS NULL OR octet_length(response_body_json) <= 65536");

                            t.HasCheckConstraint("ck_idempotency_requests_retention", "expires_at > created_at AND delete_after > expires_at");

                            t.HasCheckConstraint("ck_idempotency_requests_status", "status IN ('Processing', 'Completed')");
                        });
                });
